function [sys, seq_imp] = genera_sequenza_impulsi_MOD(sys)
...
%%  Calcoliamo il commutatore di Mx ed Mz
    comm = sys.Sz*sys.Sx - sys.Sx*sys.Sz;
...
%%  Primo Impulso   
    ...
    imp_1.angolo  = abs(h(lv(1),lv(2))/comm(lv(1),lv(2)));
    imp_1.fase    = angle(h(lv(1),lv(2))/comm(lv(1),lv(2)));
...
%   Rimozione completa leackage
    ...
    imp_1.d_Sz             = abs(sys.Sz(lv(2),lv(2)) - sys.Sz(lv(1),lv(1)));
    imp_1.d_Mz             = abs(sys.Mz(lv(2),lv(2)) - sys.Mz(lv(1),lv(1)));
...
%%  Secondo Impulso   
    ...
    imp_2.angolo  = abs(h(lv(1),lv(2))/comm(lv(1),lv(2)));
    imp_2.fase    = angle(h(lv(1),lv(2))/comm(lv(1),lv(2)));
...
%   Rimozione completa leackage
    ...
    imp_2.d_Sz             = abs(sys.Sz(lv(2),lv(2)) - sys.Sz(lv(1),lv(1)));
    imp_2.d_Mz             = abs(sys.Mz(lv(2),lv(2)) - sys.Mz(lv(1),lv(1)));
...
%%  Terzo Impulso   
    ...
    imp_3.angolo  = abs(h(lv(1),lv(2))/comm(lv(1),lv(2)));
    imp_3.fase    = angle(h(lv(1),lv(2))/comm(lv(1),lv(2)));
...
%   Rimozione completa leackage
    ...
    imp_3.d_Sz             = abs(sys.Sz(lv(2),lv(2)) - sys.Sz(lv(1),lv(1)));
    imp_3.d_Mz             = abs(sys.Mz(lv(2),lv(2)) - sys.Mz(lv(1),lv(1)));
...
%%  Quarto Impulso   
    ...
    imp_4.angolo  = abs(h(lv(1),lv(2))/comm(lv(1),lv(2)));
    imp_4.fase    = angle(h(lv(1),lv(2))/comm(lv(1),lv(2)));
% % %     imp_4.angolo  = pi/2; %%%%%%%%%%%%%%% DBG
% % %     imp_4.fase    = pi/2; %%%%%%%%%%%%%%% DBG
...
%   Rimozione completa leackage
    ...
    imp_4.d_Sz             = abs(sys.Sz(lv(2),lv(2)) - sys.Sz(lv(1),lv(1)));
    imp_4.d_Mz             = abs(sys.Mz(lv(2),lv(2)) - sys.Mz(lv(1),lv(1)));
...
%   stessa durata
    imp_1.Bz = B_max * (imp_1.w * h_bar) * imp_1.angolo;
    imp_2.Bz = B_max * (imp_2.w * h_bar) * imp_2.angolo;
    imp_3.Bz = B_max * (imp_3.w * h_bar) * imp_3.angolo;
    imp_4.Bz = B_max * (imp_4.w * h_bar) * imp_4.angolo;
