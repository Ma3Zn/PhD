...
% %   Parte risonante lungo z (Rimozione totale Leackage)
%     V = (imp.Bz * cos(mod(imp.w * t + imp.fase, 2*pi))) * (U * imp.Mz * U');

%   Parte risonante lungo z (Rimozione parziale Leackage)
    V = (imp.Bz * cos(mod(imp.w * t + imp.fase, 2*pi)));
end