...
% % % %   Tempi esecuzioni operazioni logiche -- E/D = 0.3
% % %     t_es(4)  = 1.09;
% % %     t_es(6)  = 3.46;
% % %     t_es(8)  = 11.1;
% % %     t_es(10) = 41.0;
...
% % % %   Tempi esecuzioni operazioni logiche -- E/D = 0.2
% % %    t_es(4)  = 1.46;
% % %    t_es(6)  = 4.35;
% % %    t_es(8)  = 20.3;

%   Tempi esecuzioni operazioni logiche -- E/D = 0.1
   t_es(4)  = 2.85;
   t_es(6)  = 18.3;
   t_es(8)  = 174.;
...
%   Riempiamo sim con i parametri necessari
    ...
    sim.t_es    = t_es;     % tempo esecuzione operazioni logiche
