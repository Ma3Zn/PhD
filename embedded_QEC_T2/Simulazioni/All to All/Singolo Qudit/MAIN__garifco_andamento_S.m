...
for T2 = T2_vals
    ...
    idx1 = 1;
    errore_medio(idx1) = grafico_errore_medio_1_2(T2, angle_vals, init_superposition);
    idx1 = 2;
...
% Salviamo il grafico
legend('$T_2 = 100\mu s$', '$T_2 = 10 \mu s$', '$T_2 = 1\mu s$', 'Interpreter','latex','Location', 'southwest','FontSize',16.2);
