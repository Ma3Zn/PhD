...
%   Aggiungiamo le prime condizioni di Knill-Laflamme al vettore dei
%   vincoli
    ceq(n_v+1:n_v + n_kl) = KLI;

%   Aggiorniamo il numero di vincoli di uguaglianza
    n_v = n_v + n_kl;

%   Aggiungiamo le seconde condizioni di Knill-Laflamme al vettore dei
%   vincoli
    ceq(n_v+1:n_v + n_kl) = KLII;
