function sop_inc = costruisci_sop_inc_T1(W, dim)
...
%   Superoperatore errore
    ...
    for a = 1:dim
        for b = 1:dim
            ...
            tmp = 2 * genera_superoperatore_sx(BA) * genera_superoperatore_dx(AB) ...
                    - genera_superoperatore_sx(AA) - genera_superoperatore_dx(AA);
